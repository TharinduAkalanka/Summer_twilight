...
<div class="container py-xl-5 py-sm-3" style="padding-top:30px;margin-left:0px;padding-bottom:15px;">

<div>
<a  class="btn btn-info" name="showall"  href="../index.html" style="float:left;margin-left:0px;"><i class="glyphicon glyphicon-home" style="float:left;margin-right:5px;"></i> Index Page</a>
</div>
